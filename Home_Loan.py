...
st.set_page_config(page_title="Loan Calculator by Devarshi")
st.write("# Home Loan")
...
P = col1.number_input("Principal Amount", min_value=0, value=5000000)
R = col2.number_input("Rate of intrest", min_value=0.00, value=9.00)
N = col3.number_input("Tenure of Loan", min_value=1, value=10)
